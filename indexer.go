...
func EventIndexCallback(orm *gorm.DB, swapTargetAddedEventTracker SwapTargetAddedEventTracker, swapTargetRemovedEventTracker SwapTargetRemovedEventTracker, tokenWithdrawnEventTracker TokenWithdrawnEventTracker, ethWithdrawnEventTracker EthWithdrawnEventTracker, txLogs []ethrpc.Log, ethClient *EthBlockChainRPCWithRetry) error {
	...
	go func() {
		...
		for true {
			...
			if len(topicsInterestedIn) > 0 {
				...
				err := EventIndexCallback(orm, swapTargetAddedEventTracker, swapTargetRemovedEventTracker, tokenWithdrawnEventTracker, ethWithdrawnEventTracker, receiptLogs.receipts, ethRPCClient)
				if err != nil {
